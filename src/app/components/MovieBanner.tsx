...
const MovieBanner = ({ movie }) => (
    <div className="relative h-[500px] md:h-[700px] flex items-end pb-32 px-12">
        ...
        <div className="relative max-w-2xl">
            ...
            <div className="mt-6 flex gap-4">
                ...
                <a href={movie.trailer} target="_blank" rel="noreferrer" className="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg text-lg font-bold flex items-center gap-2">
